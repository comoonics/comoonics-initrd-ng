...
#
#****h* sles11/network-scripts/etc/sles10/network-lib.sh
#  NAME
#    network-lib.sh
#    $id$
#  DESCRIPTION
...
#****f* sles11/network-lib.sh/sles11_ip2Config
#  NAME
#    sles11_ip2Config
#  SYNOPSIS
...
function sles11_ip2Config() {
  ...
  [ -z "$networkpath" ] && local networkpath=${__prefix}/$(sles11_get_networkpath)
...
#****f* sles11/network-lib/sles11_get_networkpath
#  NAME
#    sles11_get_networkpath
#  SYNOPSIS
#    function sles11_get_networkpath()
#  MODIFICATION HISTORY
#  IDEAS
