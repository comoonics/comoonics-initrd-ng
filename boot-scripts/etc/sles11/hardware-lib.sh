#
# $Id: hardware-lib.sh,v 1.1 2009-09-28 12:45:31 marc Exp $
#
# @(#)$File$
#
...
#****f* boot-scripts/etc/sles11/sles11_hardware_detect
#  NAME
#    suse_hwscan
#  SYNOPSIS
#    function sles11_hardware_detect() {
#  MODIFICATION HISTORY
#  IDEAS
#  SOURCE
#
...
#************ sles11_hardware_detect

#****f* hardware-lib.sh/sles11_udev_start
#  NAME
#    udev_start
#  SYNOPSIS
#    function boot-lib.sh/sles11_udev_start
#  MODIFICATION HISTORY
#  IDEAS
#  SOURCE
#
function sles11_udev_start() {
